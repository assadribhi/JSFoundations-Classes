...
class Vendor extends Person {
  ...
  sellTo = (custumer, numberOfIcerCreams) => {
    this.moveTo(custumer.location);
    custumer.wallet.debit(numberOfIcerCreams * this.price);
    this.wallet.credit(numberOfIcerCreams * this.price);
  };
}
